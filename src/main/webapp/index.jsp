...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img  height="50" width="30" src="<c:url value="resources/images/logo.png" />" /></a>
    </div>
		          ...
		          <div class="thumbnail">
		            <img src="http://placehold.it/500x300" alt="">
		              <div class="caption">
		                ...
		                <p><a href="#" class="btn btn-info btn-xs" role="button">Details</a> <a href="#" class="btn btn-default btn-xs" role="button">Review</a></p>
		            </div>
		          </div>
		        </div>	
	    	<% }%>
